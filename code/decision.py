...
def decision_step(Rover):
    ...
    if Rover.nav_angles is not None and not Rover.picking_up:
        ...
        if Rover.mode[-1] == 'forward':
            ...
            stuck_limit = 0.6 if Rover.mode[-2] == 'rock' else 1
            if Rover.total_time - Rover.stuck_time > stuck_limit:
            ...
            if Rover.samples_dists is None and Rover.samples_angles is None:
                Rover.mode.pop()
            else:
